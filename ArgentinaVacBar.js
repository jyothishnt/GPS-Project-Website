...
var svg = d3.select("#bar-two")
  ...
  if (countryValue == 'Cambodia') {
    var data = [
      { category: "Vaccine Period", PrePCV: '289', NouniversalintroductiontoPCV: '0', introPCV7: '0', prePCV7: '0', PCV7: '0', PostPCV7: '0', introPCV10: '0', PostPCV10: '0', introPCV10and13: '0', introPCV13: '103', PCV13: '0', PostPCV13: '521', Unknown: '0'}
    ];
  }
  if (countryValue == 'The Gambia') {
    var data = [
      { category: "Vaccine Period", PrePCV: '0', NouniversalintroductiontoPCV: '0', introPCV7: '238', prePCV7: '1081', PCV7: '0', PostPCV7: '241', introPCV10: '0', PostPCV10: '0', introPCV10and13: '0', introPCV13: '27', PCV13: '0', PostPCV13: '177', NVT: '0', VRT: '0', Unknown: '8'}
    ];
  }
  if (countryValue == 'Hong Kong') {
    var data = [
      { category: "Vaccine Period", PrePCV: '0', NouniversalintroductiontoPCV: '0', introPCV7: '67', prePCV7: '309', PCV7: '0', PostPCV7: '0', introPCV10: '20', PostPCV10: '78', introPCV10and13: '0', introPCV13: '27', PCV13: '0', PostPCV13: '177', NVT: '0', VRT: '0', Unknown: '8'}
    ];
  }
  ...
  if (countryValue == 'Nepal') {
    var data = [
      { category: "Vaccine Period", PrePCV: '0', NouniversalintroductiontoPCV: '0', introPCV7: '0', prePCV7: '1', PostPCV7: '0', prePCV10: '475', introPCV10: '0', PostPCV10: '0', PostPCV13: '0', NVT: '0', VRT: '0', Unknown: '0'}
    ];
  }
  if (countryValue == 'Nigeria') {
    var data = [
      { category: "Vaccine Period", PrePCV: '2', NouniversalintroductiontoPCV: '0', introPCV7: '0', prePCV7: '0', PostPCV7: '0', prePCV10: '0', introPCV10: '17', PostPCV10: '48', PostPCV13: '0', NVT: '0', VRT: '0', Unknown: '0'}
    ];
  }
  if (countryValue == 'Pakistan') {
    var data = [
      { category: "Vaccine Period", PrePCV: '5', NouniversalintroductiontoPCV: '0', introPCV7: '0', prePCV7: '0', PCV7: '0', PostPCV7: '0', introPCV10: '1', PostPCV10: '64', introPCV10and13: '0', introPCV13: '0', PCV13: '0', PostPCV13: '0', Unknown: '32'}
    ];
  }
  ...
  if (countryValue == 'Poland') {
    var data = [
      { category: "Vaccine Period", PrePCV: '0', NouniversalintroductiontoPCV: '0', introPCV7: '8', prePCV7: '46', PCV7: '0', PostPCV7: '57', introPCV10: '29', PostPCV10: '30', introPCV10and13: '0', introPCV13: '33', PCV13: '0', PostPCV13: '67', NVT: '0', VRT: '0', Unknown: '0'}
    ];
  }
